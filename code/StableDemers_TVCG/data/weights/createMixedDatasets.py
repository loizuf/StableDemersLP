...
names_temp = {
	...
	"USA": ["DrugFatalities", "GDP", "GeneralElectionTurnout", "Population"],
...
for date in sys.argv[2:]:
	...
	for df in dfs:
		# print(date)
		# print(df.columns[2])
		if sys.argv[1] == "USA" and date == "2010" and df.columns[2] == "2011":
			date = "2011"
		columns.append(df[str(date)])
		if sys.argv[1] == "USA" and date == "2011" and df.columns[2] == "2011":
			date = "2010"
